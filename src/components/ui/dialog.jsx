...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      // border bg-background px-6 pt-6 pb-2
      className={cn(
      ...
      <DialogPrimitive.Close
        className="absolute -right-12 top-0 rounded-full opacity-100 bg-white p-[4px] ring-offset-background transition-opacity hover:opacity-60 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
        <X className="h-5 w-5 text-trasparent" />
